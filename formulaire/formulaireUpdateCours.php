...
<script>
    ...
    $("#selectProf").change(function()
    {
        $.ajax(
        {
            ...
            data:"id_prof="+ $("#selectProf").val() +"&date=" + $("#date").val() + "&id_classe=" + $("#selectClasse").val() + "&id_cours=" + $("#idCours").val(),
            success:function(data)
            {
...
<form id ="formu" action ="controller/cours/updateCours.php" method="POST" >
<input hidden name="id" id="idCours" value="<?php echo $_GET['id']; ?>">
